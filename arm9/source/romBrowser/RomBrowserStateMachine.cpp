...
bool RomBrowserStateMachine::FireDirect(RomBrowserStateTrigger trigger)
{
    ...
    if (StateMachineTriggerChecker(_curState, trigger)
        ...
        .In(RomBrowserState::Browser)
            ...
            .Trigger(RomBrowserStateTrigger::ShowSaveManagement).GoesTo(RomBrowserState::SaveManagement)
        ...
        .In(RomBrowserState::SaveManagement)
            .Trigger(RomBrowserStateTrigger::HideSaveManagement).GoesTo(RomBrowserState::Browser)
